      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Full-screen broadcast is controlled by iOS. SH Rec cannot stop it from inside the app.',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 14,
            ...
            const _StopStep(
              number: '3',
              text: 'Reopen SH Rec so your recording can import and save to Photos.',
            ),
            const SizedBox(height: 20),
            SizedBox(
