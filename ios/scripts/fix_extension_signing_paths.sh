...
replacements = [
    ...
    (
        "com.azrecorder.screenrecording.com.azrecorder.screenrecording.BroadcastUploadExSetupUI",
    ...
    (
        ...
        "PRODUCT_BUNDLE_IDENTIFIER = com.azrecorder.screenrecording.BroadcastUploadExSetupUI;",
    ),
    (
    ...
    (
        "com.azrecorder.screenrecording.BroadcastUploadExSetupUI/com.azrecorder.screenrecording.BroadcastUploadExSetupUI.entitlements",
        "BroadcastUploadExtensionSetupUI/BroadcastUploadExtensionSetupUI.entitlements",
    ),
    (
    ...
    (
        "INFOPLIST_FILE = com.azrecorder.screenrecording.BroadcastUploadExSetupUI/Info.plist",
        "INFOPLIST_FILE = BroadcastUploadExtensionSetupUI/Info.plist",
    ),
    (
    ...
    (
        "path = com.azrecorder.screenrecording.BroadcastUploadExSetupUI;",
        "path = BroadcastUploadExtensionSetupUI;",
    ),
    (
    ...
    (
        "path = com.azrecorder.screenrecording.BroadcastUploadExSetupUI.appex",
        "path = BroadcastUploadExtensionSetupUI.appex",
    ),
    (
    ...
    (
        "name = com.azrecorder.screenrecording.BroadcastUploadExSetupUI;",
        "name = BroadcastUploadExtensionSetupUI;",
    ),
    (
    ...
    (
        "productName = com.azrecorder.screenrecording.BroadcastUploadExSetupUI;",
        "productName = BroadcastUploadExtensionSetupUI;",
    ),
    (
    ...
    (
        "remoteInfo = com.azrecorder.screenrecording.BroadcastUploadExSetupUI;",
        "remoteInfo = BroadcastUploadExtensionSetupUI;",
    ),
    (
    ...
    (
        'PBXNativeTarget "com.azrecorder.screenrecording.BroadcastUploadExSetupUI"',
        'PBXNativeTarget "BroadcastUploadExtensionSetupUI"',
    ),
    (
    ...
    (
        "/* com.azrecorder.screenrecording.BroadcastUploadExSetupUI.appex",
        "/* BroadcastUploadExtensionSetupUI.appex",
    ),
    (
        "/* com.azrecorder.screenrecording.BroadcastPlugun */",
